...
sketch.draw( (
  ...
  for ( let layer = 0; layer < layers; layer++ ) {
    ...
    cells.forEach( (
      ...
      const progression = index / ( cells.length - 1 );
      const {
        x, y
      } = position;
      ...
      const rotationNoise = p.noise(
        ...
        layerProgression + circularSwitchIndex// * noiseLayerProgressionMultiplier + progression * noiseProgressionMultiplier// + rZ
      );
