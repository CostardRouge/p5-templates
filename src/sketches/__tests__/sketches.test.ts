 ...
 *
 * Asserts that every entry in `src/sketches/metadata.json` resolves to a
...
import metadata from "@/sketches/metadata.json";
 ...
 * the kind of mismatch that ships a broken `/sketches/...` page.
 */
describe(
