...
/**
 * Format GPS coordinates to a human-readable location string
 * Attempts to fetch city name from OpenStreetMap, falls back to coordinates
 */
...
/**
 * Format latitude and longitude as coordinate string
...
const ExifInfo = ({ exifData, visible, className, children }: ExifInfoProps) => {
  const [computedGPSInfo, setComputedGPSInfo] = useState<
