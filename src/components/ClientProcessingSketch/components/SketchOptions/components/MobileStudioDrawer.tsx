...
type MobileStudioDrawerProps = {
  ...
  /** Only for the recording-lock banner: the drawer no longer hosts capture. */
...
export default function MobileStudioDrawer( {
  ...
  return (
    // The measured wrapper hugs its content: no `h-full`, no `inset-0` — it
    // sits over the canvas and any extra box would be an invisible pointer
