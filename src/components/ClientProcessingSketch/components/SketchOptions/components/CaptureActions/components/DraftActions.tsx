...
export default function DraftActions( {
  ...
  return (
    <>
      ...
      <button
        className="rounded-xl px-3 py-2.5 border border-red-500/20 text-red-500 bg-red-500/5 hover:bg-red-500/10 disabled:opacity-50 disabled:cursor-not-allowed text-xs font-medium transition-all inline-flex items-center justify-center gap-1.5"
        onClick={ onDelete }
        disabled={ isAnyActionLoading }
      >
        {deleting ? (
