...
import { getRecordingSteps, createStepConfig, getCurrentStepIndex, getCompletedStepsCount } from '../recordingSteps';
import { JobModel } from '@/types/recording.types';

describe('getRecordingSteps', () => {
  const createJob = (progress: number, status: string = 'active'): JobModel => ({
    id: 'test-job',
    progress,
  ...
  describe('Draft/Queued recordings', () => {
    it('should return all pending steps for draft recordings', () => {
      const job = createJob(0, 'draft');
    ...
    it('should return all pending steps for queued recordings', () => {
      const job = createJob(0, 'queued');
      const steps = getRecordingSteps(job);
    ...
    it('should return all pending steps for 0% progress', () => {
      const job = createJob(0, 'active');
      const steps = getRecordingSteps(job);
  ...
  describe('Progress distribution', () => {
    it('should activate first step at 5% progress', () => {
    ...
    it('should complete first step and activate second at 25%', () => {
    ...
    it('should handle mid-recording progress correctly', () => {
    ...
    it('should handle near-completion progress', () => {
    ...
    it('should complete all steps at 100%', () => {
  ...
  describe('Custom step configuration', () => {
    it('should work with custom 3-step configuration', () => {
    ...
    it('should work with equal-weight steps', () => {
      const customSteps = createStepConfig([
...
describe('createStepConfig', () => {
  it('should return config as-is when weights sum to 100', () => {
    const config = [
      { id: 'step1', name: 'Step 1', weight: 50 },
      { id: 'step2', name: 'Step 2', weight: 50 },
    ];
  ...
  it('should normalize weights when they do not sum to 100', () => {
    ...
    const result = createStepConfig(config);
    expect(result[0].weight).toBeCloseTo(45.45, 1); // 50/110 * 100
    expect(result[1].weight).toBeCloseTo(54.55, 1); // 60/110 * 100
  });

  it('should handle small weight differences', () => {
    const config = [
      { id: 'step1', name: 'Step 1', weight: 33.33 },
      { id: 'step2', name: 'Step 2', weight: 33.33 },
      { id: 'step3', name: 'Step 3', weight: 33.33 }, // Total: 99.99
    ];
...
describe('getCurrentStepIndex', () => {
  it('should return index of active step', () => {
    const steps = [
      { id: '1', name: 'Step 1', status: 'completed' as const, percentage: 100 },
      { id: '2', name: 'Step 2', status: 'active' as const, percentage: 50 },
      { id: '3', name: 'Step 3', status: 'pending' as const, percentage: 0 },
    ];

    expect(getCurrentStepIndex(steps)).toBe(1);
  });

  it('should return 0 when no step is active', () => {
    const steps = [
      { id: '1', name: 'Step 1', status: 'pending' as const, percentage: 0 },
      { id: '2', name: 'Step 2', status: 'pending' as const, percentage: 0 },
    ];
...
describe('getCompletedStepsCount', () => {
  it('should count completed steps correctly', () => {
    const steps = [
      { id: '1', name: 'Step 1', status: 'completed' as const, percentage: 100 },
      { id: '2', name: 'Step 2', status: 'completed' as const, percentage: 100 },
      { id: '3', name: 'Step 3', status: 'active' as const, percentage: 50 },
      { id: '4', name: 'Step 4', status: 'pending' as const, percentage: 0 },
    ];
  ...
  it('should return 0 when no steps are completed', () => {
    const steps = [
      { id: '1', name: 'Step 1', status: 'active' as const, percentage: 50 },
      { id: '2', name: 'Step 2', status: 'pending' as const, percentage: 0 },
    ];
