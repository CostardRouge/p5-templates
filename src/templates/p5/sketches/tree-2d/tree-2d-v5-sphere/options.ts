...
export const formValues = {
  ...
  waves: {
    strengthEasing: "easeInOutSine",
    countEasing: "easeInOutSine",
    countMax: 2,
    amplitudeXDivider: 3,
    amplitudeY: 200
  },
  lines: {
    count: 4,
    length: 75,
    lengthEasing: "easeInOutSine",
    weightMin: 10,
    weightMax: 20,
    weightEasing: "easeInOutExpo",
    swappedVertices: true
  },
  rotation: {
    speed: 2,
    count: 1,
...
export const formConfiguration: Record<string, any> = {
  ...
  lines: {
    ...
    fields: {
      ...
      swappedVertices: {
        label: "Swapped vertices (sphere effect)",
        component: "checkbox"
      }
    }
  },
