...
export const formValues = {
  ...
  flow: {
    // "progressive" morphs the cluster from word to word; "instant" snaps it onto
    // each word.
    mode: "progressive" as "progressive" | "instant",
    // Fraction of each word-step spent resting on the current word before moving.
    dwell: 0.45,
    // Stagger of the morph along the curve (0 = all points together).
    spread: 0.6,
    // Which end of the curve leads the morph ("start" or "end") — for variation.
