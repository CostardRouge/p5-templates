...
sketch.draw( ( time, center, favoriteColor ) => {
    ...
    const circlePosition = createVector(width/2, height-height/4)
    ...
    for (let imageObjectIndex = 0; imageObjectIndex < images.length; imageObjectIndex++ ) {
      ...
      const angle = map(imageObjectIndexProgression, 0, 1, 9*PI/6, PI/2)
    ...
    const defaultTitle = "photo-circle-rotation.js".toUpperCase().replaceAll('-', "\n")
