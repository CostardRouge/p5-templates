import { sketch, animation, easing, mappers, imageUtils, string, events, captureOptions as options, cache, grid, colors } from '/assets/scripts/p5-sketches/utils/index.js';
...
sketch.draw( ( time, center, favoriteColor ) => {
  ...
  gridCells.forEach( ({position, xIndex, yIndex}, cellIndex ) => {
    ...
    const switchIndex = (
      +noise(xIndex, yIndex, timeIndex)
      +noise(x/width, y/height, cellIndex)
    )
