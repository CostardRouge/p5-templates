...
function dice(size = width, render) {
  const rotations = [
    ...
    canvases.dice.createVector(0, HALF_PI), // right
    canvases.dice.createVector(HALF_PI), // up
    canvases.dice.createVector(0, -HALF_PI), // left
    canvases.dice.createVector(0, PI), // back
  ...
  for (let i = 0; i < rotations.length; i++) {
    ...
    canvases.dice.translate(0, 0, size/2);
