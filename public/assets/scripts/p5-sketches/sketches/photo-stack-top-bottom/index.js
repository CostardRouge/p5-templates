import { sketch, easing, mappers, animation, string, shapes, imageUtils, events, cache, captureOptions as options } from '/assets/scripts/p5-sketches/utils/index.js';
...
sketch.draw( (_time, center, favoriteColor) => {
    ...
    for (let i = 0; i < images.length; i++) {
        ...
        imageUtils.marginImage({
            position: createVector(width/2, y),
            center: true,
            scale: .8,
            margin,
            img
